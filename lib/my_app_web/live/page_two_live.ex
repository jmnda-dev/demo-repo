defmodule MyAppWeb.PageTwoLive do
  use MyAppWeb, :live_view

  def render(assigns) do
    ~H"""
    <h1 class="text-5xl">Page 2 live</h1>

    <div class="container">
    <div class="w-3/5 ">
    <%= live_redirect to: Routes.live_path(@socket, MyAppWeb.PageOneLive) do %>
    <button type="button" class="my-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-6 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Go to Page 1 live</button>
    <% end %>

    <p class="my-5 text-2xl">Accordion</p>
    ...
    <h1 class="text-2xl my-5">Modal</h1>
